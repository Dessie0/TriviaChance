...
public class itemRegistry extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("INSERT into items (itemName, description, rarity) VALUES (\"Main Theme\", \"This is the first item.\", \"Common\");"); //Repeat this for every item.
        ...
        sqLiteDatabase.execSQL("INSERT into items (itemName, description, rarity) VALUES (\"Purple Theme\", \"This is the seventh item.\", \"Rare\");"); //Repeat this for every item.
        sqLiteDatabase.execSQL("INSERT into items (itemName, description, rarity) VALUES (\"Forest Theme\", \"This is the eigth item.\", \"Rare\");"); //Repeat this for every item.
        sqLiteDatabase.execSQL("INSERT into items (itemName, description, rarity) VALUES (\"Orange Theme\", \"This is the ninth item.\", \"Rare\");"); //Repeat this for every item.
    }
